  ...
  return (
    <div
      className={cn(
        ...
        "flex flex-col",
        "h-auto md:h-[24rem]", // Fixed height for md and up
        "md:col-span-1",
        className
      )}
    >
      {header}
      <div className="group-hover/bento:translate-x-2 transition duration-200 flex-1 flex flex-col overflow-auto">
        {/* {icon} */}
        <div className="font-sans font-bold text-neutral-600 dark:text-neutral-200 mb-2 mt-2">
          {title}
        </div>
        <div className="font-sans font-normal text-neutral-600 dark:text-neutral-300 overflow-y-auto">
          {description}
        </div>
      </div>
    </div>
